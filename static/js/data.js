/* ============================================================
   ...
   ------------------------------------------------------------
   All training content lives here, derived from the
   "Assistant - Shadow Shift Plan" document.
   To add new material, just add entries to these arrays.
...
const CONTENT = {
  ...
  uniform: [
    { id:"khaki",    slot:"bottoms", label:"Fingertip-length khaki shorts", icon:"\u{1FA73}", ok:true,  why:"Khaki bottoms at fingertip length or longer. Perfect." },
    { id:"jeans",    slot:"bottoms", label:"Full-length jeans",             icon:"\u{1F456}", ok:true,  why:"Jeans are allowed as long as they are fingertip-length or longer." },
    { id:"white",    slot:"bottoms", label:"White athletic pants",          icon:"\u{1F97C}", ok:false, why:"No white or multi-colored pants." },
    { id:"tiedye",   slot:"bottoms", label:"Multi-colored joggers",         icon:"\u{1F308}", ok:false, why:"No white or multi-colored pants." },
    { id:"shortsh",  slot:"bottoms", label:"Shorts above fingertip length", icon:"\u{1FA71}", ok:false, why:"Bottoms must reach fingertip length or longer." },

    { id:"deptshirt",slot:"top",     label:"Department shirt for your position", icon:"\u{1F455}", ok:true,  why:"Department shirt that matches your position. Correct." },
    { id:"ksblue",   slot:"top",     label:"Kent State blue and gold tee",  icon:"\u{1F499}", ok:false, friday:true, why:"Kent State apparel is Blue and Gold Friday only." },
    { id:"cardigan", slot:"top",     label:"Cardigan over your shirt",      icon:"\u{1F9E5}", ok:false, why:"No sweaters, cardigans or cover-ups." },
    { id:"randomtee",slot:"top",     label:"Neon graphic tee",              icon:"\u{1F3A8}", ok:false, why:"Your shirt has to be the department shirt for your position." },

    { id:"nametag",  slot:"badge",   label:"Nametag",                       icon:"\u{1F4DB}", ok:true,  why:"Nametag is required every shift." },
    { id:"nonametag",slot:"badge",   label:"Skip the nametag today",        icon:"\u{1F6AB}", ok:false, why:"The nametag is part of the uniform. No exceptions." },

    { id:"sneakers", slot:"shoes",   label:"Tennis / athletic shoes",       icon:"\u{1F45F}", ok:true,  why:"Tennis or athletic shoes only." },
    { id:"boots",    slot:"shoes",   label:"Work boots",                    icon:"\u{1F97E}", ok:false, why:"No boots, sandals or open-toed shoes." },
    { id:"sandals",  slot:"shoes",   label:"Slides",                        icon:"\u{1FA74}", ok:false, why:"No boots, sandals or open-toed shoes." },

    { id:"longsleeve",slot:"layer",  label:"Navy long-sleeve UNDER uniform",icon:"\u{1F9E3}", ok:true,  why:"Grey, white or navy long-sleeves may be worn under the uniform." },
    { id:"hoodie",   slot:"layer",   label:"Hoodie over uniform",           icon:"\u{1F9E5}", ok:false, why:"No cover-ups over the uniform." },
    { id:"nolayer",  slot:"layer",   label:"No extra layer",                icon:"\u{2705}",  ok:true,  why:"A layer is optional. No layer is always fine." }
  ],
  ...
  scenarios: [
    ...
    /* ===== WEIGHT ROOM (61) ===== */
    { id:"wr1", pos:"61", zone:"Weight Room", tag:"Policy",
    ...
    { id:"wr2", pos:"61", zone:"Weight Room", tag:"Re-Rack",
    ...
    { id:"wr3", pos:"61", zone:"Weight Room", tag:"Presence",
    ...
    { id:"wr4", pos:"61", zone:"Weight Room", tag:"Safety",
      ...
      options:[
        ...
        { t:"Intervene early: ask them to stop, explain clips are always required and that dropping or slamming weights is prohibited.", correct:true },
    ...
    { id:"wr5", pos:"61", zone:"Weight Room", tag:"Equipment",
    ...
    { id:"wr6", pos:"61", zone:"Weight Room", tag:"Solo Opening",
    ...
    { id:"wr7", pos:"61", zone:"Weight Room", tag:"Policy",
    ...
    { id:"wr8", pos:"61", zone:"Weight Room", tag:"Policy",
    ...
    { id:"wr9", pos:"61", zone:"Weight Room", tag:"Emergency",
    ...
    { id:"wr10", pos:"61", zone:"Weight Room", tag:"Coverage",
    ...
    /* ===== COURTS (62) ===== */
    { id:"ct1", pos:"62", zone:"Court 4", tag:"Priority",
      ...
      teach:"Badminton and pickleball take priority on Court 4. Upon notification, the existing basketball game is permitted to end and play one more winner game, then the court goes to badminton." },

    { id:"ct2", pos:"62", zone:"Court 3", tag:"Priority",
      ...
      teach:"Court 3 priority order: Intramurals, Leagues and Youth Programs, Sport Clubs (fencing), Informal Volleyball, then Facility Rental. If patrons are trying to play volleyball, people cannot be playing basketball on Court 3 at the same time." },

    { id:"ct3", pos:"62", zone:"Court 2", tag:"Fight",
      text:"Two patrons start throwing punches on Court 2.",
      options:[
        { t:"\"62 to all available staff, come to Court 2 immediately\", then contain, do not touch, do not let anyone leave.", correct:true },
    ...
    { id:"ct4", pos:"62", zone:"Courts", tag:"Supervision",
    ...
    { id:"ct5", pos:"62", zone:"Courts", tag:"Equipment",
    ...
    { id:"ct6", pos:"62", zone:"Courts", tag:"Policy",
    ...
    { id:"ct7", pos:"62", zone:"Courts", tag:"Next Game",
      text:"The losing team wants to stay on and run it back. Two patrons courtside called next ten minutes ago.",
      options:[
        { t:"Losing team can stay if they won the last two.", correct:false },
        { t:"The losing team exits. Patrons waiting for next game have priority over the losing team.", correct:true },
        { t:"Whoever gets on the court first.", correct:false },
        { t:"Split the court in half.", correct:false }
      ],
      teach:"Participants must be present to call next. The losing team must exit the court, and patrons waiting for next game have priority over players from the losing team. If the winning team gives up the court, waiting patrons get priority. Patrons may only claim next game on one court." },

    { id:"ct8", pos:"62", zone:"Court 4", tag:"Nets",
    ...
    { id:"ct9", pos:"62", zone:"Courts", tag:"Closing",
    ...
    { id:"ct10", pos:"62", zone:"MPG", tag:"Emergency",
    ...
    /* ===== CLEANER (60) ===== */
    { id:"cl1", pos:"60", zone:"Lower Fit", tag:"Supplies",
    ...
    { id:"cl2", pos:"60", zone:"Laundry", tag:"Towels",
    ...
    { id:"cl3", pos:"60", zone:"Upper Fit", tag:"Cleaning",
    ...
    { id:"cl4", pos:"60", zone:"iPad", tag:"Task Tracker",
    ...
    { id:"cl5", pos:"60", zone:"Facility", tag:"Counts",
    ...
    { id:"cl6", pos:"60", zone:"Locker Room", tag:"BBP",
    ...
    { id:"cl7", pos:"60", zone:"Locker Room", tag:"Closing",
    ...
    { id:"cl8", pos:"60", zone:"Laundry", tag:"Ice",
    ...
    /* ===== ANY POSITION - FACILITY POLICIES ===== */
    { id:"an1", pos:"any", zone:"Upper Fit", tag:"Patron Dress",
    ...
    { id:"an2", pos:"any", zone:"Lower Fit", tag:"Patron Dress",
    ...
    { id:"an3", pos:"any", zone:"Circuit", tag:"Food and Drink",
    ...
    { id:"an4", pos:"any", zone:"Facility", tag:"Tobacco",
    ...
    { id:"an5", pos:"any", zone:"Lower Fit", tag:"Age Policy",
    ...
    { id:"an6", pos:"any", zone:"Upper Fit", tag:"Photo and Video",
    ...
    { id:"an7", pos:"any", zone:"Facility", tag:"Locker Rooms",
    ...
    { id:"an8", pos:"any", zone:"Locker Room", tag:"Day-Use Lockers",
    ...
    { id:"an9", pos:"any", zone:"Facility", tag:"Tornado",
    ...
    { id:"an10", pos:"any", zone:"Facility", tag:"Med Bag",
    ...
    { id:"an11", pos:"any", zone:"Facility", tag:"EAP",
    ...
    { id:"an12", pos:"any", zone:"Welcome Desk", tag:"Alarms",
    ...
    { id:"an13", pos:"any", zone:"Home", tag:"Shift Coverage",
    ...
    { id:"an14", pos:"any", zone:"Home", tag:"Timeliness",
    ...
    { id:"an15", pos:"any", zone:"Facility", tag:"Timeliness",
    ...
    { id:"an16", pos:"any", zone:"Facility", tag:"Mocks and Audits",
  ...
  closing: {
    "61": {
      ...
      items: [
        ...
        { t:"Start closing duties during the last 15 minutes of open hours", ok:false,
          why:"Do NOT begin closing duties during the final 15 minutes of closing hours." },
  ...
  /* ---------- BADGES ---------- */
  badges: [
    { id:"dressed", name:"Uniform Ready",    icon:"\u{1F454}",        desc:"Clocked in with a flawless uniform." },
    { id:"ontime",  name:"On the 55",        icon:"\u{23F0}",         desc:"Nailed the timeliness round." },
    { id:"radio",   name:"Radio Voice",      icon:"\u{1F4FB}",        desc:"Perfect radio call: right number, right phrase, right pause." },
    { id:"streak5", name:"Hot Streak",       icon:"\u{1F525}",        desc:"5 correct calls in a row on the floor." },
    { id:"noflag",  name:"Clean Shift",      icon:"\u{2728}",         desc:"Finished the floor with confidence never dropping below 70%." },
    { id:"closer",  name:"Closer",           icon:"\u{1F511}",        desc:"Perfect closing checklist." },
    { id:"solo",    name:"Cleared for Solo", icon:"\u{1F396}\u{FE0F}",desc:"Scored 85% or better across the whole shift." }
  ]
};

/* ---------- RADIO DRILLS (Round 3) ---------- */
CONTENT.radioDrills = [
