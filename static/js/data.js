...
const CONTENT = {
  ...
  urgency: [
    ...
    },
    {
      ...
      pauseNote_: "PAUSE and wait for \"66 go ahead\" before you continue."
    },
    {
  ...
  uniform: [
    ...
    { id: "ksblue", slot: "top", label: "Kent State blue and gold tshirt", icon: "\u{1F499}", ok: false, friday: true, why: "Kent State apparel is Blue and Gold Friday only." },
    { id: "cardigan", slot: "top", label: "Cardigan over your shirt", icon: "\u{1F9E5}", ok: false, why: "No sweaters, cardigans or cover-ups." },
    { id: "randomtee", slot: "top", label: "Neon graphic tshirt", icon: "\u{1F3A8}", ok: false, why: "Your shirt has to be the department shirt for your position." },
...
CONTENT.radioDrills = [
...

  {
    ...
    to: "all available staff", phrase: "Right now", pause: false,
